package com.portal.livros.config.customgrant;
...
public class CustomPasswordAuthenticationProvider implements AuthenticationProvider {
	...
	public Authentication authenticate(Authentication authentication) throws AuthenticationException {
		...
		var newcontext = SecurityContextHolder.createEmptyContext(); // <- Cria contexto
		newcontext.setAuthentication(oAuth2ClientAuthenticationToken); // <- Seta autenticação
		SecurityContextHolder.setContext(newcontext);		// <- Define como contexto atual
